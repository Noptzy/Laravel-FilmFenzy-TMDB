        ...
        <div class="w-auto flex flex-row overflow-x-auto pl-28 pt-6 pb-10">
            @foreach ($tvShow as $tvShowItem)
                @php
                    ...
                    $tvID = $tvShowItem->id;
                    $tvTitle = $tvShowItem->name;
                    $tvRating = $tvShowItem->vote_average * 10;
                    $tvImage = "{$imageBaseURL}/w500{$tvShowItem->poster_path}";
                @endphp
                ...
                <a href="movie/{{ $tvID }}" class="group">
                    <div
                        ...
                        <div class="flex flex-row mt-1 items-center">
                            ...
                            <span class="font-inter text-sm ml-1 font-bold">{{ $tvRating }}%</span>
                        </div>
                    </div>
                </a>
            @endforeach
